...
function M.opts()
  ...
  config.defaults.actions.files["ctrl-r"] = function(_, ctx)
    ...
    require("fzf-lua").cmd(ctx.__INFO.cmd, o)
  end
...
M.keys = {
  ...
  { "<leader>fF", "<cmd>FzfLua files cwd=$PWD<cr>", desc = "Find Files (cwd)" },
  { "<leader>fg", "<cmd>FzfLua git_files<cr>", desc = "Find Files (git-files)" },
  { "<leader>fr", "<cmd>FzfLua oldfiles<cr>", desc = "Recent" },
  { "<leader>fR", "<cmd>FzfLua oldfiles cwd=$PWD<cr>", desc = "Recent (cwd)" },
  -- git
  ...
  { "<leader>sG", "<cmd>FzfLua live_grep cwd=$PWD<cr>", desc = "Grep (cwd)" },
  ...
  { "<leader>sW", "<cmd>FzfLua grep_cword cwd=$PWD<cr>", desc = "Word (cwd)" },
  { "<leader>sw", "<cmd>FzfLua grep_visual<cr>", mode = "v", desc = "Selection (Root Dir)" },
  { "<leader>sW", "<cmd>FzfLua grep_visual cwd=$PWD<cr>", mode = "v", desc = "Selection (cwd)" },
